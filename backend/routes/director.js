...
router.get('/dashboard', verifyToken, verifyRole('Director', 'Planeacion', 'Admin', 'Consultor', 'Decano'), getDashboardDirector);
router.get('/docente/:id/distribucion', verifyToken, verifyRole('Director', 'Planeacion', 'Admin', 'Consultor', 'Decano'), getDistribucionDocente);
...
router.get('/asignaciones', verifyToken, verifyRole('Director', 'Decano', 'Consultor', 'Planeacion', 'Admin'), getAsignaciones);
...
router.get('/agendas', verifyToken, verifyRole('Director', 'Consultor', 'Decano'), getAgendas);
router.get('/agendas/:id', verifyToken, verifyRole('Director', 'Consultor', 'Decano'), getAgendaDetalle);
...
// Reportes
router.get('/reportes/resumen', verifyToken, verifyRole('Director', 'Planeacion', 'Admin', 'Consultor', 'Decano'), getReportesResumen);
